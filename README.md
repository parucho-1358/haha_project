...
1.  [🤝 협업 증빙 (Notion)](#-협업-증빙-notion)
2.  [🚀 기획 의도](#-기획-의도)
    * [문제의식](#-문제의식)
    * [핵심 목표](#-핵심-목표)
    * [참고 사이트 및 차별점](#-참고-사이트--차별점)
3.  [✨ 구현한 핵심 기능](#-구현한-핵심-기능)
4.  [🛠️ 사용 기술 (Tech Stack)](#-사용-기술-tech-stack)
5.  [⚙️ 시스템 아키텍처](#-시스템-아키텍처)
6.  [📄 API 명세서](#-api-명세서)
7.  [💻 주요 흐름 상세 구현](#-주요-흐름-상세-구현)
    * [Home](#1-home)
    * [Search](#2-search)
    * [Discover](#3-discover)
...
* `React.lazy()`,`<Suspense />`를 사용해 **초기 로딩 성능을 최적화**했습니다.

#### ◾ 핵심 구현 방식 (CRUD Flow)
* **Create (등록)**:
   * 제목과 내용 텍스트 입력후 등록버튼을 눌러 게시글을 등록합니다.

* **Read (조회)**
    * 초기 - 제목목록 표출 -> 클릭 (오픈) -> 내용보임
